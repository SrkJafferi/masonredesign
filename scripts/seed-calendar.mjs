...
const hijriMonths = [
  ...
  { hijri_year: 1448, hijri_month: 2, gregorian_start: "2026-07-16" },  // Safar 1448 (corrected: observed moon-sighting)
  { hijri_year: 1448, hijri_month: 3, gregorian_start: "2026-08-15" },  // Rabi-ul-Awwal 1448 (corrected: Safar 30 days -> 1 Rau on 08-15)
...
/**
 * Islamic events. Each event is anchored to an AUTHORITATIVE Hijri date
 * (hijri_year / hijri_month / hijri_day). event_date is the Gregorian date
 * derived from the current hijri_months boundaries at seed time — it is a
 * cache, not the source of truth; the app derives it live from the Hijri
 * anchor. Multiple events may share a date (sort_order breaks ties). category
 * is a free label used for the public badges (Wiladat, Martyrdom, Wafat, Eid,
 * Shab, Ziarat, Historical, Other).
 *   { event_date, hijri_year, hijri_month, hijri_day, title, category?, sort_order? }
 */
const calendarEvents = [
  { event_date: "2026-01-03", hijri_year: 1447, hijri_month: 7, hijri_day: 13, title: "Wiladat: Imam Ali Ibne Abu Talib (AS)", category: "Wiladat", sort_order: 0 },
  { event_date: "2026-01-05", hijri_year: 1447, hijri_month: 7, hijri_day: 15, title: "Martyrdom: Saani-e-Zahra, Bibi Zainab (SA)", category: "Martyrdom", sort_order: 0 },
  { event_date: "2026-01-12", hijri_year: 1447, hijri_month: 7, hijri_day: 22, title: "Nazr-e-Imam Jafar-us-Sadiq (AS)", category: "Historical", sort_order: 0 },
  { event_date: "2026-01-14", hijri_year: 1447, hijri_month: 7, hijri_day: 24, title: "Fathe-Khyber badaste-Maula Ali Ibne Abi Talib (AS)", category: "Historical", sort_order: 0 },
  { event_date: "2026-01-15", hijri_year: 1447, hijri_month: 7, hijri_day: 25, title: "Martyrdom: Imam Moosa Kazim (AS)", category: "Martyrdom", sort_order: 0 },
  { event_date: "2026-01-16", hijri_year: 1447, hijri_month: 7, hijri_day: 26, title: "Wafat: Hazrat Abu Talib (SA)", category: "Wafat", sort_order: 0 },
  { event_date: "2026-01-17", hijri_year: 1447, hijri_month: 7, hijri_day: 27, title: "Yaum-e-Be'sat / Mairaj-un-Nabi", category: "Historical", sort_order: 0 },
  { event_date: "2026-01-18", hijri_year: 1447, hijri_month: 7, hijri_day: 28, title: "Safar-e-Imam Hussain (AS): Madina to Karbala (60 Hijri)", category: "Historical", sort_order: 0 },
  { event_date: "2026-01-20", hijri_year: 1447, hijri_month: 8, hijri_day: 1, title: "Wiladat: BiBi Zainab S.A.", category: "Wiladat", sort_order: 0 },
  { event_date: "2026-01-21", hijri_year: 1447, hijri_month: 8, hijri_day: 2, title: "Fasting in Ramzan was made compulsory", category: "Historical", sort_order: 0 },
  { event_date: "2026-01-22", hijri_year: 1447, hijri_month: 8, hijri_day: 3, title: "Wiladat: Imam Hussain (AS)", category: "Wiladat", sort_order: 0 },
  { event_date: "2026-01-23", hijri_year: 1447, hijri_month: 8, hijri_day: 4, title: "Wiladat: Hazrat Abbas Alamdar (AS)", category: "Wiladat", sort_order: 0 },
  { event_date: "2026-01-24", hijri_year: 1447, hijri_month: 8, hijri_day: 5, title: "Wafat: Bibi Fizza (SA)", category: "Wafat", sort_order: 0 },
  { event_date: "2026-01-26", hijri_year: 1447, hijri_month: 8, hijri_day: 7, title: "Wiladat: Hazrat Qasim Ibne Hasan (AS)", category: "Wiladat", sort_order: 0 },
  { event_date: "2026-01-30", hijri_year: 1447, hijri_month: 8, hijri_day: 11, title: "Wiladat: Hazrat Ali Akbar Ibne Hussain (AS)", category: "Wiladat", sort_order: 0 },
  { event_date: "2026-02-03", hijri_year: 1447, hijri_month: 8, hijri_day: 15, title: "Wiladat: Imam Mehdi Aakhir-uz-Zaman (AS); Shab-e-Bara'at", category: "Wiladat", sort_order: 0 },
  { event_date: "2026-02-23", hijri_year: 1447, hijri_month: 9, hijri_day: 6, title: "Torah was revealed", category: "Historical", sort_order: 0 },
  { event_date: "2026-02-27", hijri_year: 1447, hijri_month: 9, hijri_day: 10, title: "Wafat: Hazrat Khadija (SA)", category: "Wafat", sort_order: 0 },
  { event_date: "2026-03-01", hijri_year: 1447, hijri_month: 9, hijri_day: 12, title: "Bible was revealed", category: "Historical", sort_order: 0 },
  { event_date: "2026-03-04", hijri_year: 1447, hijri_month: 9, hijri_day: 15, title: "Wiladat: Imam Hasan (AS)", category: "Wiladat", sort_order: 0 },
  { event_date: "2026-03-06", hijri_year: 1447, hijri_month: 9, hijri_day: 17, title: "Battle of Badr was fought", category: "Historical", sort_order: 0 },
  { event_date: "2026-03-07", hijri_year: 1447, hijri_month: 9, hijri_day: 18, title: "Zabur was revealed", category: "Historical", sort_order: 0 },
  { event_date: "2026-03-08", hijri_year: 1447, hijri_month: 9, hijri_day: 19, title: "Subhe Zarbat: Imam Ali Ibne Abi Talib (AS)", category: "Historical", sort_order: 0 },
  { event_date: "2026-03-10", hijri_year: 1447, hijri_month: 9, hijri_day: 21, title: "Martyrdom: Imam Ali Ibne Abi Talib (AS)", category: "Martyrdom", sort_order: 0 },
  { event_date: "2026-03-11", hijri_year: 1447, hijri_month: 9, hijri_day: 22, title: "Shab-e-Qadr: Quran was revealed", category: "Shab", sort_order: 0 },
  { event_date: "2026-03-13", hijri_year: 1447, hijri_month: 9, hijri_day: 24, title: "Juma'tul Wida / Yaum-e-Quds", category: "Historical", sort_order: 0 },
  { event_date: "2026-03-20", hijri_year: 1447, hijri_month: 10, hijri_day: 1, title: "Eid-Ul-Fitr", category: "Eid", sort_order: 0 },
  { event_date: "2026-03-27", hijri_year: 1447, hijri_month: 10, hijri_day: 8, title: "Mourning: Jannat-ul-Baqee demolished by Aal-e-Saud", category: "Historical", sort_order: 0 },
  { event_date: "2026-03-29", hijri_year: 1447, hijri_month: 10, hijri_day: 10, title: "Ghaibat Kubra (Imam Aakhir-uz-Zaman AS) began", category: "Historical", sort_order: 0 },
  { event_date: "2026-04-03", hijri_year: 1447, hijri_month: 10, hijri_day: 15, title: "Martyrdom: Imam Jafar-us-Sadiq (AS)", category: "Martyrdom", sort_order: 0 },
  { event_date: "2026-04-05", hijri_year: 1447, hijri_month: 10, hijri_day: 17, title: "Battle of Uhud was fought", category: "Historical", sort_order: 0 },
  { event_date: "2026-04-28", hijri_year: 1447, hijri_month: 11, hijri_day: 11, title: "Wiladat: Imam Ali Raza (AS)", category: "Wiladat", sort_order: 0 },
  { event_date: "2026-05-12", hijri_year: 1447, hijri_month: 11, hijri_day: 25, title: "Wiladat: Hazrat Ibrahim (AS) and Hazrat Eesaa (AS)", category: "Wiladat", sort_order: 0 },
  { event_date: "2026-05-16", hijri_year: 1447, hijri_month: 11, hijri_day: 29, title: "Martyrdom: Imam Mohammad Taqi (AS)", category: "Martyrdom", sort_order: 0 },
  { event_date: "2026-05-18", hijri_year: 1447, hijri_month: 12, hijri_day: 1, title: "Wedding: Imam Ali (AS) and Bibi Fatima Zehra (SA)", category: "Historical", sort_order: 0 },
  { event_date: "2026-05-20", hijri_year: 1447, hijri_month: 12, hijri_day: 3, title: "Allah accepted Hazrat Adam's (AS) dua", category: "Historical", sort_order: 0 },
  { event_date: "2026-05-22", hijri_year: 1447, hijri_month: 12, hijri_day: 5, title: "Wafat: Hazrat Abu Zur Ghaffari (RA)", category: "Wafat", sort_order: 0 },
  { event_date: "2026-05-24", hijri_year: 1447, hijri_month: 12, hijri_day: 7, title: "Martyrdom: Imam Mohammad Baqir (AS)", category: "Martyrdom", sort_order: 0 },
  { event_date: "2026-05-25", hijri_year: 1447, hijri_month: 12, hijri_day: 8, title: "Imam Hussain left Makkah towards Karbala", category: "Historical", sort_order: 0 },
  { event_date: "2026-05-26", hijri_year: 1447, hijri_month: 12, hijri_day: 9, title: "Yaum-e-Arafat", category: "Historical", sort_order: 0 },
  { event_date: "2026-05-26", hijri_year: 1447, hijri_month: 12, hijri_day: 9, title: "Martyrdom: Hazrat Muslim Ibne Aqeel (AS)", category: "Martyrdom", sort_order: 1 },
  { event_date: "2026-05-27", hijri_year: 1447, hijri_month: 12, hijri_day: 10, title: "Eid-ul-Azha", category: "Eid", sort_order: 0 },
  { event_date: "2026-06-01", hijri_year: 1447, hijri_month: 12, hijri_day: 15, title: "Wiladat: Imam Ali-an-Naqi (AS)", category: "Wiladat", sort_order: 0 },
  { event_date: "2026-06-04", hijri_year: 1447, hijri_month: 12, hijri_day: 18, title: "Eid Al-Ghadir", category: "Eid", sort_order: 0 },
  { event_date: "2026-06-05", hijri_year: 1447, hijri_month: 12, hijri_day: 19, title: "Shab-e-Rukhsati: Bibi Fatima Zehra (SA)", category: "Shab", sort_order: 0 },
  { event_date: "2026-06-08", hijri_year: 1447, hijri_month: 12, hijri_day: 22, title: "Martyrdom: Tiflaan-e-Muslim Ibne Aqeel (AS)", category: "Martyrdom", sort_order: 0 },
  { event_date: "2026-06-10", hijri_year: 1447, hijri_month: 12, hijri_day: 24, title: "Eid-e-Mubahila", category: "Eid", sort_order: 0 },
  { event_date: "2026-06-17", hijri_year: 1448, hijri_month: 1, hijri_day: 2, title: "Imam Hussain (AS) reached Karbala", category: "Historical", sort_order: 0 },
  { event_date: "2026-06-20", hijri_year: 1448, hijri_month: 1, hijri_day: 5, title: "Ziarat: Taaboot-e-Hazrat Aun-w-Mohammad (as)", category: "Ziarat", sort_order: 0 },
  { event_date: "2026-06-21", hijri_year: 1448, hijri_month: 1, hijri_day: 6, title: "Ziarat: Taaboot-e-Hazrat Ali Akbar (as)", category: "Ziarat", sort_order: 0 },
  { event_date: "2026-06-22", hijri_year: 1448, hijri_month: 1, hijri_day: 7, title: "Mehndi: Hazrat Qasim (as)", category: "Historical", sort_order: 0 },
  { event_date: "2026-06-23", hijri_year: 1448, hijri_month: 1, hijri_day: 8, title: "Ziarat: Alam-e-Hazrat Abbas Alamdar (as)", category: "Ziarat", sort_order: 0 },
  { event_date: "2026-06-24", hijri_year: 1448, hijri_month: 1, hijri_day: 9, title: "Shab-e-Ashoor/Ziarat:Gehwaara-e-Hazrat Ali Asghar (as)", category: "Shab", sort_order: 0 },
  { event_date: "2026-06-25", hijri_year: 1448, hijri_month: 1, hijri_day: 10, title: "Ashoora-e-Muharram", category: "Historical", sort_order: 0 },
  { event_date: "2026-06-25", hijri_year: 1448, hijri_month: 1, hijri_day: 10, title: "Martyrdom: Imam Hussain (AS)", category: "Martyrdom", sort_order: 1 },
  { event_date: "2026-06-27", hijri_year: 1448, hijri_month: 1, hijri_day: 12, title: "Soyem / Ziyarat-e-Shuhada-e-Karbala", category: "Ziarat", sort_order: 0 },
  { event_date: "2026-07-10", hijri_year: 1448, hijri_month: 1, hijri_day: 25, title: "Martyrdom: Imam Zain-ul-Abideen (AS)", category: "Martyrdom", sort_order: 0 },
  { event_date: "2026-07-12", hijri_year: 1448, hijri_month: 1, hijri_day: 27, title: "Martyrdom: Hazrat Mesam-e-Tammar (RA)", category: "Martyrdom", sort_order: 0 },
  { event_date: "2026-07-16", hijri_year: 1448, hijri_month: 2, hijri_day: 1, title: "Ahle-Haram (AS) entered Yazid's (LA) darbar", category: "Historical", sort_order: 0 },
  { event_date: "2026-07-22", hijri_year: 1448, hijri_month: 2, hijri_day: 7, title: "Wiladat: Imam Moosa Kazim (AS)", category: "Wiladat", sort_order: 0 },
  { event_date: "2026-07-24", hijri_year: 1448, hijri_month: 2, hijri_day: 9, title: "Battle of Naharwan was won", category: "Historical", sort_order: 0 },
  { event_date: "2026-07-28", hijri_year: 1448, hijri_month: 2, hijri_day: 13, title: "Martyrdom: Bibi Sakina binte Hussain (AS)", category: "Martyrdom", sort_order: 0 },
  { event_date: "2026-08-01", hijri_year: 1448, hijri_month: 2, hijri_day: 17, title: "Martyrdom: Imam Ali Raza (AS)", category: "Martyrdom", sort_order: 0 },
  { event_date: "2026-08-04", hijri_year: 1448, hijri_month: 2, hijri_day: 20, title: "Arbaeen-e-Shuhada-e-Karbala", category: "Historical", sort_order: 0 },
  { event_date: "2026-08-08", hijri_year: 1448, hijri_month: 2, hijri_day: 24, title: "Martyrdom: BiBi Zainab (SA) (ref)", category: "Martyrdom", sort_order: 0 },
  { event_date: "2026-08-12", hijri_year: 1448, hijri_month: 2, hijri_day: 28, title: "Wafat: Hazrat Mohammad Mustafa (SAWW)", category: "Wafat", sort_order: 0 },
  { event_date: "2026-08-12", hijri_year: 1448, hijri_month: 2, hijri_day: 28, title: "Martyrdom: Imam Hasan (AS)", category: "Martyrdom", sort_order: 1 },
  { event_date: "2026-08-18", hijri_year: 1448, hijri_month: 3, hijri_day: 4, title: "Wafat: Masooma-e-Qum (SA)", category: "Wafat", sort_order: 0 },
  { event_date: "2026-08-22", hijri_year: 1448, hijri_month: 3, hijri_day: 8, title: "Martyrdom: Imam Hasan Askari (AS)", category: "Martyrdom", sort_order: 0 },
  { event_date: "2026-08-23", hijri_year: 1448, hijri_month: 3, hijri_day: 9, title: "Eid-e-Zehra (SA)", category: "Eid", sort_order: 0 },
  { event_date: "2026-08-31", hijri_year: 1448, hijri_month: 3, hijri_day: 17, title: "Wiladat: Hazrat Mohammad Mustafa (SAWW)", category: "Wiladat", sort_order: 0 },
  { event_date: "2026-08-31", hijri_year: 1448, hijri_month: 3, hijri_day: 17, title: "Wiladat: Imam Ja'far-us-Sadiq (AS)", category: "Wiladat", sort_order: 1 },
  { event_date: "2026-09-01", hijri_year: 1448, hijri_month: 3, hijri_day: 18, title: "Wiladat: Bibi Umme Kulsoom binte Ali (SA)", category: "Wiladat", sort_order: 0 },
  { event_date: "2026-09-21", hijri_year: 1448, hijri_month: 4, hijri_day: 10, title: "Wiladat: Imam Hasan Askari (AS)", category: "Wiladat", sort_order: 0 },
  { event_date: "2026-10-24", hijri_year: 1448, hijri_month: 5, hijri_day: 13, title: "Martyrdom: Bibi Sayedda Fatima Zehra S.A.", category: "Martyrdom", sort_order: 0 },
  { event_date: "2026-10-26", hijri_year: 1448, hijri_month: 5, hijri_day: 15, title: "Wiladat: Imam Zain-ul-Abideen (AS)", category: "Wiladat", sort_order: 0 },
  { event_date: "2026-11-13", hijri_year: 1448, hijri_month: 6, hijri_day: 3, title: "Martyrdom: Shehzadi Fatima Zehra (SA)", category: "Martyrdom", sort_order: 0 },
  { event_date: "2026-11-20", hijri_year: 1448, hijri_month: 6, hijri_day: 10, title: "Battle of Jamal was won", category: "Historical", sort_order: 0 },
  { event_date: "2026-11-30", hijri_year: 1448, hijri_month: 6, hijri_day: 20, title: "Wiladat: Shehzadi Fatima Zehra (SA)", category: "Wiladat", sort_order: 0 },
  { event_date: "2026-12-10", hijri_year: 1448, hijri_month: 7, hijri_day: 1, title: "Wiladat: Imam Mohammad Baqir (AS)", category: "Wiladat", sort_order: 0 },
  { event_date: "2026-12-12", hijri_year: 1448, hijri_month: 7, hijri_day: 3, title: "Martyrdom: Imam Ali Naqi (AS)", category: "Martyrdom", sort_order: 0 },
  { event_date: "2026-12-14", hijri_year: 1448, hijri_month: 7, hijri_day: 5, title: "Wiladat: Imam Ali Naqi (AS)", category: "Wiladat", sort_order: 0 },
  { event_date: "2026-12-18", hijri_year: 1448, hijri_month: 7, hijri_day: 9, title: "Wiladat: Hazrat Ali Asghar Ibne Hussain (AS)", category: "Wiladat", sort_order: 0 },
  { event_date: "2026-12-19", hijri_year: 1448, hijri_month: 7, hijri_day: 10, title: "Wiladat: Imam Mohammad Taqi (AS)", category: "Wiladat", sort_order: 0 },
  { event_date: "2026-12-22", hijri_year: 1448, hijri_month: 7, hijri_day: 13, title: "Wiladat: Imam Ali Ibne Abu Talib (AS)", category: "Wiladat", sort_order: 0 },
  { event_date: "2026-12-24", hijri_year: 1448, hijri_month: 7, hijri_day: 15, title: "Martyrdom: Saani-e-Zahra, Bibi Zainab (SA)", category: "Martyrdom", sort_order: 0 },
  { event_date: "2026-12-31", hijri_year: 1448, hijri_month: 7, hijri_day: 22, title: "Nazr-e-Imam Jafar-us-Sadiq (AS)", category: "Historical", sort_order: 0 },
];
